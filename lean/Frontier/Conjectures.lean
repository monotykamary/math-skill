...
Work order: 1 → 6. Each comment names the move; the moves come from the
reference derivations, not from thin air.
-/

namespace Frontier

/-- Conjecture 1: the geometric identity from case-ewma.md §2.
...
/-- Conjecture 3: cooling between related prompts.
...
/-- Conjecture 5 (case-large-deviations.md §1): Markov's inequality on a
